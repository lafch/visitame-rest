...
public class AccountServiceImpl extends BaseServiceImpl implements AccountService {
	...
	public CustomerDetail getCustomer(String documentNumber, String documentType , String test) throws NegocioException {
		...
		try {
			...
			if(StringUtils.isBlank(test)){
				...
				result =  zicServiceAccountHelper.getListCustomers(test+".json");
			}
	...
	private CustomerDetail getDatosCustomer(String documentNumber, String documentType , String test) throws NegocioException {
		return getCustomer(documentNumber, documentType , test);
	}
	
	private CustomerDetail getDatosCustomer(String documentNumber, String documentType) throws NegocioException {
		return getCustomer(documentNumber, documentType , null);
	}
	...
	public Map<String, Object> validarUsuario(String documentNumber, String documentType , String desDocumentType ,String captchaResponse ,String ipRemote, String codOficina) throws NegocioException {
		...
		//Modo dummy
		//CustomerDetail datosCustumer = getDatosCustomer(documentNumber, documentType , documentNumber);
		//Modo dummy
		CustomerDetail datosCustumer = getDatosCustomer(documentNumber, documentType);
